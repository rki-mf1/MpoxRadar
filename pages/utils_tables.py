...
class OverviewTable:
    ...
    def _sort_by_sum_of_both_frequencies(
        ...
        variantView_df_overview_both = variantView_df_overview_both.loc[sorted_indices, :].reset_index(
            drop=True)
    ...
    def count_shared_mutation_in_left_and_right_selection(
        ...
        variantView_df_overview_both = pd.merge(
            ...
            how='inner',
            on=[self.variant_col]).reset_index(drop=True)
    ...
    def create_overview_table(
        ...
        column_names = [{"name": self.column_names[i], "id": j}
