...
from pages.utils_explorer_filter import get_all_frequency_sorted_countries, get_mutations_by_filters, \
...
def get_compare_callbacks(df_dict, variantView_cds, color_dict):
    ...
    def actualize_mutation_filter(
        ...
        mut_options_1 = get_frequency_sorted_mutation_by_df(gene_mutations_df_left, color_dict)
        mut_options_2 = get_frequency_sorted_mutation_by_df(gene_mutations_df_right, color_dict)
        mut_options_3 = get_frequency_sorted_mutation_by_df(gene_mutations_df_inner, color_dict)
