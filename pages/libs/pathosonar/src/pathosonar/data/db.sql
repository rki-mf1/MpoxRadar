...
*/
DROP DATABASE IF EXISTS `patho_db`;
CREATE DATABASE IF NOT EXISTS `patho_db` CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `patho_db`;
...
CREATE TABLE IF NOT EXISTS `variant` (
	...
	PRIMARY KEY(id),
	-- # Change VARCHAR to TEXT, if we choose VARCAHR(200)
...
CREATE TABLE IF NOT EXISTS `annotation_type` (
	...
	`impact` VARCHAR(10) DEFAULT NULL COLLATE 'utf8mb3_general_ci',
	PRIMARY KEY (`id`) USING BTREE
);
INSERT INTO `annotation_type` (`id`, `seq_ontology`, `region`,`impact`)
VALUES (1, 'coding_sequence_variant', 'EXON', 'MODIFIER'),
(2, 'chromosome', 'NONE', 'HIGH'),
(3, 'duplication', 'EXON', 'HIGH'),
(4, 'inversion', 'EXON', 'HIGH'),
(5, 'inframe_insertion', 'EXON', 'MODERATE'),
(6, 'disruptive_inframe_insertion', 'EXON', 'MODERATE'),
(7, 'inframe_deletion', 'EXON', 'MODERATE'),
(8, 'disruptive_inframe_deletion', 'EXON', 'MODERATE'),
(9, 'downstream_gene_variant', 'DOWNSTREAM', 'MODIFIER'),
(10, 'exon_variant', 'EXON', 'MODIFIER'),
(11, 'exon_loss_variant', 'EXON', 'HIGH'),
(12, 'frameshift_variant', 'EXON', 'HIGH'),
(13, 'gene_variant', 'GENE', 'MODIFIER'),
(14, 'feature_ablation', 'GENE', 'HIGH'),
(15, 'gene_fusion', 'GENE', 'HIGH'),
(16, 'bidirectional_gene_fusion', 'GENE', 'HIGH'),
(17, 'rearranged_at_DNA_level', 'GENE', 'HIGH'),
(18, 'intergenic_region', 'INTERGENIC', 'MODIFIER'),
(19, 'conserved_intergenic_variant', 'INTERGENIC', 'MODIFIER'),
(20, 'intragenic_variant', 'INTERGENIC', 'MODIFIER'),
(21, 'intron_variant', 'INTRON', 'MODIFIER'),
(22, 'conserved_intron_variant', 'INTRON', 'MODIFIER'),
(23, 'miRNA', 'MICRO_RNA', 'MODIFIER'),
(24, 'missense_variant', 'EXON', 'MODERATE'),
(25, 'initiator_codon_variant', 'EXON', 'LOW'),
(26, 'stop_retained_variant', 'EXON', 'LOW'),
(27, 'protein_protein_contact', 'EXON', 'HIGH'),
(28, 'structural_interaction_variant', 'EXON', 'HIGH'),
(29, 'rare_amino_acid_variant', 'EXON', 'HIGH'),
(30, 'splice_acceptor_variant', 'SPLICE_SITE_ACCEPTOR', 'HIGH'),
(31, 'splice_donor_variant', 'SPLICE_SITE_DONOR', 'HIGH'),
(32, 'splice_region_variant', 'SPLICE_SITE_REGION', 'LOW'),
(33, 'stop_lost', 'EXON', 'HIGH'),
(34, '5_prime_UTR_premature_start_codon_gain_variant', 'UTR_5_PRIME', 'LOW'),
(35, 'stop_gained', 'EXON', 'HIGH'),
(36, 'synonymous_variant', 'EXON', 'LOW'),
(37, 'start_lost', 'EXON', 'HIGH'),
(38, 'regulatory_region_variant', 'REGULATION', 'MODIFIER'),
(39, 'upstream_gene_variant', 'GENE', 'MODIFIER'),
(40, '3_prime_UTR_variant', 'UTR_3_PRIME', 'MODIFIER'),
(41, '3_prime_UTR_truncation_+_exon_loss_variant', 'UTR_5_PRIME', 'MODERATE'),
(42, '5_prime_UTR_variant', 'UTR_5_PRIME', 'MODIFIER'),
(43, '5_prime_UTR_truncation_+_exon_loss_variant', 'UTR_5_PRIME', 'MODERATE'),
(44, 'sequence_feature', 'EXON or NONE', 'MODERATE'),
(45, 'start_retained_variant', 'EXON', 'LOW'),
(46, 'non_coding_transcript_variant', 'EXON or NONE', 'MODIFIER'),
(47, 'non_coding_transcript_exon_variant', 'EXON', 'MODIFIER'),
(48, 'custom', 'NONE', ''),
(49, '', 'NONE', ''),
(50, 'conservative_inframe_deletion', 'EXON', 'MODERATE'),
(51, 'conservative_inframe_insertion', 'EXON', 'MODERATE');
