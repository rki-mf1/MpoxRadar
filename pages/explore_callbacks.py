...
def get_explore_callbacks(date_slider, color_dict, location_coordinates):  # noqa: C901
    """
    ...
    # reference changed - update gene, seqtech and country dropdowns
    @callback(
        [
        ...
        # [
        #     State("gene_dropdown_0", "value"),
        #     State("country_dropdown_0", "value"),
        #     State("seq_tech_dropdown_0", "value"),
        # ],
    ...
    def reference_selection_changed(
        ...
        gene_options = data_manager.get_distinct_genes(filters)
        seq_tech_options = data_manager.get_all_seqtech(filters)
        country_options = data_manager.get_all_country(filters)
        return (
            gene_options,
            gene_options,
            seq_tech_options,
    ...
    # any filter changed - update aa mutation frequencies
    @callback(
        [
            Output("mutation_dropdown_0", "options"),
            Output("mutation_dropdown_0", "value"),
            Output("method_radio", "value"), #chain to update world map
        ],
        [
            Input("reference_radio_0", "value"),
            Input("gene_dropdown_0", "value"),
    ...
    def update_aa_mutations(
        ...
        # TODO-smc factor in pagination
        frequencies = data_manager.get_mutation_frequencies_display(filters, color_dict)
        options = [f.options_dict() for f in frequencies]
        values = [f.value for f in frequencies[:select_x_mut]]
        return options, values, method_state
