...
# from covsonar.basics import get_freq_mutation
...
def parse_args(args):
    ...
    # mut_counter parser
    subparsers.add_parser("mut_counters", parents=[general_parser])

    # counter per lab parser
    subparsers.add_parser("lab_counters", parents=[general_parser])
...
def main(args):  # noqa: C901
    ...
    elif args.tool == "mut_counters":
        sonarBasics.get_freq_mutation(args)
    else:
